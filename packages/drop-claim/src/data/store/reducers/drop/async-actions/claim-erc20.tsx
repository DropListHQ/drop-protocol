...
import DropSDK, { DropInterfaceERC20 } from '@drop-protocol/drop-sdk'
...
export default async function claim(
  ...
  try {
    ...
    const hash = await claimTokens(provider, dropSDK, index, amount, address, dropAddress, merkleProof)
