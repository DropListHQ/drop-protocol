...
export const DropFactoryInterface = new Interface([
    "function createDrop(address template, address token, bytes32 merkleRoot, uint256 expiration, bytes32 ipfsHash) returns (address drop)",
    "function getDrop(bytes32 ipfshash) view returns (address drop)",
