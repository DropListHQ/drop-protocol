...
interface IMerkleDropERC1155Interface extends ethers.utils.Interface {
  functions: {
...
export class IMerkleDropERC1155 extends BaseContract {
  ...
  interface: IMerkleDropERC1155Interface;
